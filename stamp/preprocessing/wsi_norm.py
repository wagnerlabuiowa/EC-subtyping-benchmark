...
from .helpers.feature_extractors import FeatureExtractorCTP, FeatureExtractorUNI, FeatureExtractorVirchow2, FeatureExtractorHOptimus0, FeatureExtractorProvGigaPath, FeatureExtractorViTB16, extract_features_
...
def preprocess(output_dir: Path, wsi_dir: Path, model_path: Path, cache_dir: Path, norm: bool,
               del_slide: bool, only_feature_extraction: bool, cache: bool = True, cores: int = 32,
